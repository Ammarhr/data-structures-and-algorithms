...
const charCode = (arr) => {
    // Solution code here...
    let letterArr = arr.map(letter => letter.charCodeAt());
    return letterArr;
};
...
const extractAbilities = (arr) => {
    ...
    let nameArr = [];
    arr.map(valueName => {
        nameArr.push(valueName.ability.name);
    })
    return nameArr;
};
