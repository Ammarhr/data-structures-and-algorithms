...
const countNumberOfElements = (arr) => {
    // Solution code here...
    const sum = arr.reduce((sumFar, value, index) => {
        return sumFar = sumFar + 1;
    }, 0);
    return sum;
};
...
const returnNames = (arr) => {
    // Solution code here...
    let newStars = arr.reduce((names, persons) => {
...
const countNumberOfChildren = (arr) => {
    // Solution code here...
    const newArr = arr.reduce((sumFar, profile) => {
        if (profile.children) {
...
const calculateAverage = (arr) => {
    // Solution code here...
    let countAndSum = arr.reduce((acc, value) => {
